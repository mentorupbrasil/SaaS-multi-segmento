  ...
  return (
    <div>
      ...
      <div className="card space-y-4 p-6">
        <h2 className="font-semibold text-foreground">Como ativar</h2>
        <ol className="list-decimal space-y-2 pl-5 text-sm text-muted-foreground">
          <li>Acesse <Link href="/conexoes" className="text-primary hover:underline">Conexões</Link> e habilite o provedor NF-e.</li>
