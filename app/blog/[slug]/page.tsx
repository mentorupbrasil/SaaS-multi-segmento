  ...
  return (
    <MarketingShell>
      <article className="section max-w-3xl py-16">
        <Link href="/blog" className="inline-flex items-center gap-1 text-sm font-medium text-primary hover:text-primary/80">
            ...
            if (block.type === "list") {
              return (
                <ul key={i} className="space-y-2">
                  {block.items?.map((it) => (
                    <li key={it} className="flex items-start gap-2.5 text-foreground">
