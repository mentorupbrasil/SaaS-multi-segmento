...
export function SegmentsShowcase() {
  ...
  return (
    <section id="segmentos" className="section py-16">
      <div className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-slate-600">
          Escolha o seu segmento e tudo se adapta: menus, nomenclatura, campos e módulos.
          Já são <strong className="text-slate-900">{total} segmentos</strong> prontos para usar.
        </p>
      </div>
