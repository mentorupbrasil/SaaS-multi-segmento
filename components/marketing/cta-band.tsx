  ...
  if (variant === "light") {
    return (
      <section className="section py-8 lg:py-10">
        <FadeIn>
          <div className="flex flex-col items-center justify-between gap-5 rounded-2xl border border-border bg-card px-6 py-7 shadow-sm sm:flex-row sm:px-8">
      ...
      <FadeIn>
        <div className="card-elevated relative overflow-hidden">
          ...
          <div className="relative grid gap-8 p-8 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12 lg:p-12">
            <div>
              <h2 className="text-balance text-2xl font-bold tracking-tight text-foreground sm:text-3xl">{title}</h2>
