        ...
        <div className="grid gap-10 lg:grid-cols-5 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 text-white shadow-xl">
              ...
              <div className="relative">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-card/10 px-3 py-1 text-xs font-semibold text-brand-200">
          ...
          <div className="lg:col-span-3">
            <div className="mb-6 lg:hidden">
              ...
              <h2 className="mt-3 text-2xl font-bold text-foreground">Seus dados protegidos</h2>
            </div>
